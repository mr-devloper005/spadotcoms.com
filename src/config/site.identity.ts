export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'spadotcoms',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Spadotcoms',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'spadotcoms.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://spadotcoms.com',
